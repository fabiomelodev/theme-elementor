...
<?php endif; ?>
		...
		<?php } else { ?>
			<div class="woocommerce-form-coupon-toggle mb-4">
				<?php echo esc_html__( 'Have a coupon?', 'woocommerce' ) . ' <a href="#" class="showcoupon text-v-dark text-uppercase font-weight-bold">' . esc_html__( 'INSIRA SEU CÓDIGO', 'porto' ) . '</a>'; ?>
			</div>
		<?php } ?>
