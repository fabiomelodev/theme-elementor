...
<form action="" method="post" class="woocommerce-EditAccountForm edit-account" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
		<label class="mb-1" for="account_first_name"><?php esc_html_e( 'Nome', 'porto' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
		<label class="mb-1" for="account_last_name"><?php esc_html_e( 'Sobrenome', 'porto' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
		<label class="mb-1" for="account_email"><?php esc_html_e( 'E-mail', 'porto' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<div class="featured-boxes m-t-xl m-b-lg p-l-lg p-r-lg pb-4">
		<fieldset class="mt-4">
			<legend class="text-v-dark font-weight-bold text-uppercase mb-3 text-md"><?php esc_html_e( 'Alterar senha', 'porto' ); ?></legend>

			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label class="mb-1 font-weight-medium" for="password_current"><?php esc_html_e( 'Senha atual', 'porto' ); ?></label>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label class="mb-1 font-weight-medium" for="password_1"><?php esc_html_e( 'Nova senha', 'porto' ); ?></label>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label class="mb-1 font-weight-medium" for="password_2"><?php esc_html_e( 'Confirmar nova senha', 'porto' ); ?></label>
