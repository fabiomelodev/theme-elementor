...
<h3 class="account-sub-title d-none d-md-block mb-3 mt-2"><i class="Simple-Line-Icons-social-dropbox align-middle m-r-sm"></i><?php esc_html_e( 'Pedidos', 'porto' ); ?></h3>
...
<?php if ( $has_orders ) : ?>
	...
	<div class="push-top text-center">
		<a class="woocommerce-Button button btn-v-dark btn-go-shop" href="<?php echo get_home_url( null, 'produtos' ); ?>">
			<?php esc_html_e( 'Loja', 'porto' ); ?>
		</a>
	</div>
<?php else : ?>
	</table>
