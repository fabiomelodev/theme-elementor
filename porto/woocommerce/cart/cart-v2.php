						...
						<table class="shop_table responsive cart cart-table woocommerce-cart-form__contents" cellspacing="0">
							<thead>
								<tr>
									...
									<th class="product-name"><span><?php esc_html_e( 'Produto', 'porto' ); ?></span></th>
									<th class="product-price"><span><?php esc_html_e( 'Preço', 'porto' ); ?></span></th>
									<th class="product-quantity"><span><?php esc_html_e( 'Quantidade', 'porto' ); ?></span></th>
										...
										<?php if ( wc_coupons_enabled() ) { ?>
											<div class="cart_totals_toggle">
												<div id="panel-cart-discount" class="d-sm-flex justify-content-between">
													...
													<button type="submit" class="button wc-action-btn wc-action-sm" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'porto' ); ?>"><?php esc_html_e( 'Atualizar carrinho', 'porto' ); ?></button>
												</div>
											</div>
