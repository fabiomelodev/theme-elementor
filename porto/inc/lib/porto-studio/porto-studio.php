	...
	class Porto_Studio {
		...
		public function import( $pure_return = false ) {
			...
			if ( isset( $_POST['block_id'] ) ) {
				...
				$block = json_decode( file_get_contents( "http://wordpressnull.org/porto-studio/{$_POST['block_id']}.json" ), true );
		...
		public function filter_category() {
			...
			if ( ! $blocks ) {
				...
				$blocks = json_decode( file_get_contents( "http://wordpressnull.org/porto-studio/blocks_{$this->page_type}.json" ), true );
		...
		public function get_page_content() {
			...
			if ( ! $block_categories ) {
				...
				$args['type']     = $this->page_type;
				$block_categories = json_decode( file_get_contents( "http://wordpressnull.org/porto-studio/block_categories_{$this->page_type}.json" ), true );
